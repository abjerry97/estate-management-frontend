...
function Login(props) {
  ...
  const [mailinputType, setinputType] = useState(false);
  ...
  const handleLogin = (e) => {
    e.preventDefault()
    axios
      .post(`/login?estateId=${!!currentEstate ? currentEstate._id : ""}`, {
        [mailinputType ? "email" : "phone"]: !!mailinputType
          ? email
          : phonenumber,
        password,
      })
  ...
  return (
    <div className="container">
      <div className="row d-flex justify-content-center">
        <div className="col-11 col-md-9 col-lg-5 shadow rounded-3 p-4">
          <div className="mb-3">
            <img
          ...
          <div className="">
            ...
            <p className="purple-text">
              <Link to="/">
                {" "}
                Welcome to {!!currentEstate && currentEstate.name}
              </Link>
            </p>
          </div>
          <div className="mt-2">
            ...
            <div className="d-flex align-items-center purple-border p-2">
              ...
              <input
                type={mailinputType ? "email" : "tel"}
                name=""
                id=""
                value={mailinputType ? email : phonenumber}
                //   value={searchInput}
                placeholder={`enter your ${
                  mailinputType ? "email" : "phone number"
                }`}
            ...
            <div className="d-flex align-items-center purple-border p-2 mt-4">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <div className="text-center mt-2 somehow-black-text">
          ...
          <div className="separator text-center m-0">
            <div className="line"></div>
            <p className="m-0">or</p>
            <div className="line"></div>
          </div>
          <div className="text-center mt-2 somehow-black-text">
            <Link to="/signup">Are you new?</Link>
          </div>
